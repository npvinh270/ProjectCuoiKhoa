    ...
    public class MyDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HangHoa>(e =>
            {
                ...
                e.Property(hh => hh.TenHh).IsRequired().HasMaxLength(100);
                e.Property(hh => hh.ChiTiet).HasMaxLength(200);
                e.HasIndex(hh => hh.TenHh).IsUnique();
                e.HasOne(hh => hh.Loai).WithMany(lo => lo.HangHoas)
            ...
            modelBuilder.Entity<HangHoaTag>(e =>
            {
                ...
                e.HasOne(hh => hh.HangHoa).WithMany(hht => hht.HangHoaTags).HasForeignKey(t => t.MaHangHoa);
